    ...
    <>
      ...
      <div className="min-h-screen bg-charcoal text-white flex flex-col">
        ...
        <a
          ...
          className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-primary hover:bg-violet-600 flex items-center justify-center text-white shadow-lg shadow-primary/30 transition"
